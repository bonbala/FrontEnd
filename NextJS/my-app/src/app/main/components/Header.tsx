    ...
    <div>
      <div className="top-bar flex justify-between p-[10px] pr-[15px] bg-[#181f15] max-md:hidden">
        ...
        <div className="top-bar-right flex">
          ...
          <div
            className="cart-container flex items-center text-[12px] p-[5px] gap-x-[5px] cursor-pointer"
            onClick={() => setShowCartDialog(true)}
          >
            <SlHandbag className="text-[18px] transition-transform duration-200 hover:scale-125 active:scale-150" />
            {totalItems}
          </div>
        </div>
      </div>
      ...
      <div className="main-nav-mobile fixed w-[100%] top-0 z-50 bg-white text-black py-[4px] flex justify-between items-center md:hidden  ">
        ...
        <div
          className="right-nav flex items-center justify-center bg-[#181f15] text-white  w-[60px] h-[40px]"
          onClick={() => setShowCartDialog(true)}
        >
          <SlHandbag className="text-[18px] transition-transform duration-200 hover:scale-125 active:scale-150" />
          {totalItems}
